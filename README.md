...
- `CNT64_BL64_PATH`: Bashlib64 location
- `CNT64_DEBUG`: Enable script debugging?. Assign any non-null value to enable
- `CNT64_INST64_PATH`: Container64 installers location
...
- Default location: `CNT64_INST64_PATH`
...
**Container64** is licensed under the [Apache-2.0 License](https://www.apache.org/licenses/LICENSE-2.0.txt).
